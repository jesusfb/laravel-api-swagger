...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('refresh', [\App\Http\Controllers\AuthController::class, 'refresh'])->middleware('auth');
    Route::post('me', [\App\Http\Controllers\AuthController::class, 'me'])->middleware('auth');
});
